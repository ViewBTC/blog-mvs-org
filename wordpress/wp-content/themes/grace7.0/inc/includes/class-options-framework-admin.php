	    ...
	    <div id="optionsframework-metabox" class="metabox-holder">
		    ...
		    <div id="optionsframework" class="postbox">
				...
				<div id="optionsframework-submit">
					...
					<input type="submit" class="reset-button button-secondary" name="reset" value="<?php esc_attr_e( '恢复默认', 'textdomain' ); ?>" onclick="return confirm( '<?php print esc_js( __( '您确定要这么做吗？按下确认后所有主题设置将丢失！', 'textdomain' ) ); ?>' );" />
					<div class="clear"></div>
				</div>
				</form>
			</div> <!-- / #container -->
