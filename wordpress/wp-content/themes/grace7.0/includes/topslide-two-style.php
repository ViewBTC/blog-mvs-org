<div class="top-content spe-miniwrap">
	<div class="container">
		<div class="row">
				...
				<div class="top-singles">
					...
					?>
							<div class="single-item">
								<div class="image" style="background-image:url(<?php if (get_post_meta($post->ID,"postthumb_silde_value",true ) ){ echo get_post_meta($post->ID,"postthumb_silde_value",true); } elseif( suxingme('suxingme_timthumb') ){ echo get_template_directory_uri().'/timthumb.php?src='.post_thumbnail_src().'&h=200&w=370'; } else { echo post_thumbnail_src(); } ?>)">
